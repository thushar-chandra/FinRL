...
The temporal structure of the data and the fold boundaries are shown in Figure 4. The pattern of low Sharpe ratios in early folds and high Sharpe ratios in later folds is consistent across all five random seeds (Table 2, rows grouped by seed).
